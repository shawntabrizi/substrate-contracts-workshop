...
After you press **Deploy** and a new block is formed, a system event is emitted with `contract.CodeStored` that is described in the [Polkadot UI API Documentation](https://polkadot.js.org/api/METHODS_EVENTS.html#contract). This means that you have successfully stored your WASM contract on your Substrate blockchain!
...
The _code for this contract_ is automatically set to the Flipper contract that you published. You would be able to choose from a drop down of options if you created multiple contracts.
